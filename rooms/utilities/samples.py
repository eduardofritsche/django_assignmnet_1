...
description_3 = "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."

rooms = [
    Room('single room', 40, description_1),
    Room('double room', 75, description_2),
    Room('suite', 130, description_3),
]
